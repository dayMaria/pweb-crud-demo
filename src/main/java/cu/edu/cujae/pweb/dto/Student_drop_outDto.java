...
public class Student_drop_outDto {
	...
	protected cu.edu.cujae.backend.core.dto.StudentDto studentDto;
	protected cu.edu.cujae.backend.core.dto.Drop_out_causeDto drop_out_causeDto;
	...
	public Student_drop_outDto(Integer id_student, Integer id_drop_out_cause, Integer id_student_drop_out, cu.edu.cujae.backend.core.dto.StudentDto studentDto, cu.edu.cujae.backend.core.dto.Drop_out_causeDto drop_out_causeDto) {
